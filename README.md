...
<div align="center">
  <img src="app_logo/logo_app.png" alt="AgriLens AI Logo" width="200"/>
</div>
...
| **Banana Leaf Spot** | **Mango Anthracnose** | **Pepper Scab** |
|:---:|:---:|:---:|
| ![Banana Leaf Spot](Crop%20sample/banana_Leaf-spot-diseases.jpg) | ![Mango Anthracnose](Crop%20sample/Mango%20anthracnose.jpg) | ![Pepper Scab](Crop%20sample/Pepper-scab.jpg) |

| **Tomato Disease** | **Tomato Early Blight** | **Tomato Leaf Disease** |
|:---:|:---:|:---:|
| ![Tomato Disease](Crop%20sample/tomato_desease.jpg) | ![Tomato Early Blight](Crop%20sample/tomato_early_blight.jpg) | ![Tomato Leaf Disease](Crop%20sample/tomato_leaf_disease.jpg) |

### Demo Screenshots

| **Interface Overview** | **Model Loading** | **Results Output** |
|:---:|:---:|:---:|
| ![Interface Overview](screenshots/Interface_overview2.png) | ![Model Loading](screenshots/model_fetching.png) | ![Results Output](screenshots/result_output1.png) |

| **Results Output 2** | **Results Output 3** | **Interface Overview 3** |
|:---:|:---:|:---:|
| ![Results Output 2](screenshots/result_output2.png) | ![Results Output 3](screenshots/result_output3.png) | ![Interface Overview 3](screenshots/Interface_overview3.png) |
