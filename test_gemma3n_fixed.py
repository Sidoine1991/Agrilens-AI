# =================================================================================
# Test de Génération de Texte - Gemma 3n E2B IT (Version Corrigée)
# 
...
def test_text_generation_simple(model, processor, prompt, max_new_tokens=100):
...
def main():
    ...
    for prompt in simple_prompts:
        test_text_generation_simple(model, processor, prompt)
